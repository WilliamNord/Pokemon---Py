...
gun = Move("gun", "amarican", "physical", 1000, 90, 2)
Seed_Bomb =Move("Seed-Bomb", "grass", "physical", 80, 100, 0)
Solar_Beam = Move("Solar-Beam", "grass", "special", 120, 100, 0)
Razor_Leaf = Move("Razor-Leaf", "grass", "physical" , 55, 90, 0)